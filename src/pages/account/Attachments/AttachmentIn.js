...
const Attachment = () => {
  ...
  const items = [
    { label: 'Photos', icon: 'folder', color: 'bg-orange-100', iconColor: '#3b82f6', screen: ' ' },  
    { label: 'Passport', icon: 'folder', color: 'bg-orange-100', iconColor: '#f97316', screen: ' ' },  
    { label: 'Govt IDs', icon: 'folder', color: 'bg-orange-100', iconColor: '#f97316', screen: ' ' },  
    { label: 'Visas', icon: 'folder', color: 'bg-orange-100', iconColor: '#f97316', screen: ' ' },  
    { label: 'Medical Docs', icon: 'folder', color: 'bg-orange-100', iconColor: '#f97316', screen: ' ' },  
    { label: 'Guarantor Docs', icon: 'folder', color: 'bg-orange-100', iconColor: '#f97316', screen: ' ' },  

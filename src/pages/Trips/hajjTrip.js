...
const HajjTrip = () => {
  ...
  return (
    <View className="bg-white shadow-md mt-12 rounded-[25px] overflow-hidden w-[85%] mx-auto border border-gray-200">
      {/* Image Section */}
      <View className="relative -mx-4 h-52 rounded-[25px] overflow-hidden">
        <Image
          source={require('../../assets/trip/hajjTrip.png')} 
        ...
        <View className="absolute top-[75px] left-[28px]  bg-white/90 rounded-[20px] p-4 shadow-md flex-row items-center justify-between w-[85%]">
          ...
          <View>
            <Text className="text-base font-bold text-black">Hajj</Text>
          ...
          <TouchableOpacity
        onPress={() => navigation.navigate('MyTripsHajj')} // Navigate to Signup screen
